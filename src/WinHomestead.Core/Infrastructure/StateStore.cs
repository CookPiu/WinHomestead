...
/// <summary>%ProgramData%\WinHomestead 下的 JSON 持久化。</summary>
public sealed class StateStore
{
    public StateStore(string? baseDir = null)
    {
        BaseDir = baseDir ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "WinHomestead");
